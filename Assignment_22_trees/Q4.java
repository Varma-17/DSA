...
public class Solution {
    ...
    static boolean checkPostorderCorrect(Node root,
        ...
        if (!checkPostorderCorrect(root.left, postorder, postIndex))
            return false;
        if (!checkPostorderCorrect(root.right, postorder, postIndex))
            return false;
    ...
    static boolean checkTree(int[] preorder, int[] inorder,
        ...
        return checkPostorderCorrect(root, postorder, postIndex);
    }
